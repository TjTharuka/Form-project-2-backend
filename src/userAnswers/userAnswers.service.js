// import repository
const repository = require('./userAnswers.repository');
...
module.exports.getAll = async (queryParams) => {
  return new Promise(async (resolve, reject) => {
    ...
    query = appendService.appendQueryParams(queryParams, 'userId', query,true);
    // search by body
    query = appendService.appendQueryParams(queryParams, 'paperId', query,true);
